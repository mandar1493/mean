...
export class BlogComponent implements OnInit {
  ...
  draftComment(id) {
    ...
    this.newComment.push(id); // Add the post that is being commented on to the arra
  ...
  postComment(id) {
    ...
    this.com.push(this.commentForm.get('comment').value);// Function to save the comment to the database
